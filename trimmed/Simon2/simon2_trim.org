...
:                 elpd_diff se_diff
: fit.v.exp         0.0       0.0  
: fit.v.puissance  -1.1       0.6  
: fit.v.linear    -11.6       4.3
...
:                   elpd_diff se_diff
: fit.ter.exp         0.0       0.0  
: fit.ter.puissance  -1.7       1.1  
: fit.ter.linear    -40.5      10.8
...
: fit.max_ampl.exp       -0.2       0.9   
: fit.max_ampl.linear    -1.0       1.0
...
#+BEGIN_SRC R  :results output  :exports both
  ...
  loo.meanRT_comp.puissance <-  loo(fit.meanRT_comp.puissance, reloo = TRUE)
...
: Error in loo_compare.default(loo.meanRT_comp.exp, loo.meanRT_comp.puissance,  : 
:   object 'loo.meanRT_comp.puissance' not found
: Error: object 'loo.meanRT_comp' not found
...
: fit.meanRT_incomp.exp        -0.9       1.8  
: fit.meanRT_incomp.linear    -82.2      12.7
