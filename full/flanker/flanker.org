...
#+BEGIN_SRC R  :results silent :exports none 
    ...
    setwd('~/thib/projects/developpement/full/flanker/')
...
fit.v.linear    -9.4       4.4
                elpd_diff se_diff
fit.a.puissance   0.0       0.0  
fit.a.exp        -0.6       1.5  
fit.a.linear    -22.8       8.0
                  elpd_diff se_diff
fit.ter.exp         0.0       0.0  
fit.ter.puissance  -2.3       1.0  
fit.ter.linear    -27.5       8.7
                  elpd_diff se_diff
fit.tau.exp        0.0       0.0   
fit.tau.puissance  0.0       0.3   
fit.tau.linear    -0.5       0.6
                       elpd_diff se_diff
fit.max_ampl.exp        0.0       0.0   
fit.max_ampl.puissance -0.4       0.3   
fit.max_ampl.linear    -1.1       0.6
                          elpd_diff se_diff
fit.meanRT_comp.exp          0.0       0.0 
fit.meanRT_comp.puissance  -20.8       6.2 
fit.meanRT_comp.linear    -137.6      16.0
                            elpd_diff se_diff
fit.meanRT_incomp.exp          0.0       0.0 
fit.meanRT_incomp.puissance  -21.1       6.1 
fit.meanRT_incomp.linear    -140.4      15.8
#+end_example
